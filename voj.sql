...
(1,'Notice','该OJ平台尚未完善，如有问题或需求，请联系QQ：416361536',CURRENT_TIMESTAMP);
-- --------------------------------------------------------
...
CREATE TABLE `voj_problem_difficulty` (
	`problem_difficulty_id` BIGINT(20) NOT NULL,
	`problem_difficulty_slug` VARCHAR(32) COLLATE utf8mb4_unicode_ci NOT NULL,
	`problem_difficulty_name` VARCHAR(32) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=INNODB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Dumping data for table `voj_problem_difficulty_relationships`
--
...
CREATE TABLE `voj_users` (
  ...
  `email` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `trueName` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `stuId` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `avatar` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT '/img/avatar.jpg',
...
INSERT INTO `voj_users` (`uid`, `username`, `password`, `email`, `stuid`, `user_group_id`, `prefer_language_id`) VALUES
(1000, 'zjhzxhz', '785ee107c11dfe36de668b1ae7baacbb', 'cshzxie@gmail.com', "无", "2018", "img/avatar.jgp", 8, 2),
(1001, 'voj@judger', '785ee107c11dfe36de668b1ae7baacbb', 'support@verwandlung.org', "无", "2018", "img/avatar.jgp", 4, 2),
(1002, 'another-user', '785ee107c11dfe36de668b1ae7baacbb', 'noreply@verwandlung.org', "无", "2018", "img/avatar.jgp", 2, 3);
...
--
ALTER TABLE `voj_contest_contestants`
  ADD CONSTRAINT `voj_contest_contestants_ibfk_1` FOREIGN KEY (`contest_id`) REFERENCES `voj_contests` (`contest_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `voj_contest_contestants_ibfk_2` FOREIGN KEY (`contestant_uid`) REFERENCES `voj_users` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `voj_contest_submissions`
--
ALTER TABLE `voj_contest_submissions`
  ADD CONSTRAINT `voj_contest_submissions_ibfk_1` FOREIGN KEY (`contest_id`) REFERENCES `voj_contests` (`contest_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `voj_contest_submissions_ibfk_2` FOREIGN KEY (`submission_id`) REFERENCES `voj_submissions` (`submission_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `voj_submissions`
  ...
  ADD CONSTRAINT `voj_submissions_ibfk_4` FOREIGN KEY (`submission_judge_result`) REFERENCES `voj_judge_results` (`judge_result_slug`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `voj_users`
  ADD CONSTRAINT `voj_users_ibfk_1` FOREIGN KEY (`user_group_id`) REFERENCES `voj_user_groups` (`user_group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `voj_users_ibfk_2` FOREIGN KEY (`prefer_language_id`) REFERENCES `voj_languages` (`language_id`) ON DELETE CASCADE ON UPDATE CASCADE;
